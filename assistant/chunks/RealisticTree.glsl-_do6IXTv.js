import{n as T,bF as pe,iP as za,eT as Fa,fo as Pa,j8 as $a,f9 as ce,iZ as ja,rr as Oa,kx as Ra,xJ as Rt,bn as Wt,G as c,I as G,J as j,xK as Wa,xL as Ea,bc as Et,jj as Qe,jq as de,j6 as yt,iX as Na,nE as wt,m8 as K,ky as X,hi as et,_ as B,f$ as ge,eH as Ga,eJ as Ba,aW as Nt,iJ as La,q7 as Gt,e0 as Va,x1 as N,hE as Aa,i6 as We,cy as Ha,bH as Ua,bv as ka,f6 as Ee,fa as Za,f7 as Mt,bs as Ja,fM as qa,bj as Ya}from"./embed-C4jmmvBP.js";import{L as R,aw as E,g as Bt,ax as Ie,ay as Lt,az as Vt,a9 as we,aA as Xa,aB as Ka,M as Qa,aC as se,K as x,P as At,f as U,aD as k,u as le,O as w,h as Z,R as eo,d as to,aE as Ht,ae as W,aF as De,E as tt,i as Q,t as L,Q as O,C as ze,aa as Me,aG as ao,a8 as ue,aH as oo,y as Fe,aI as io,D as Se,e as Ut,aJ as kt,x as at,b as Zt,k as ro,l as no,o as so,z as lo,j as co,r as uo,n as ho,p as mo,s as po,aK as Ne,_ as fo}from"./OutputColorHighlightOLID.glsl-CZroP9nR.js";import{t as vo,c as Pe,a as ee,i as go,r as ot,n as Jt,b as xo}from"./BooleanBindUniform-Dh5RRi28.js";import{o as J,i as bo,r as qt,s as yo,m as wo,e as Mo}from"./VertexColor.glsl-gLIiIiOy.js";import{a as So,c as Yt,d as it,o as fe,u as Xt,b as q,f as rt,_ as To,e as _o,n as Kt,O as Co}from"./MixExternalColor.glsl-BLVq1PfE.js";import{t as Ue,Q as nt}from"./InterleavedLayout-C5kS6DLw.js";import{i as $,L as Qt,Q as Te,J as St}from"./BufferView-BMJfoP0M.js";import{r as Io}from"./VertexBuffer-D2TYswpP.js";import{g as Do}from"./mathUtils-DpRFfVsw.js";import{O as te,g as ae,_ as zo}from"./renderState-DnmlZYPI.js";import{t as i,n as v,b as Fo,i as p,a as ea}from"./oitResolution.glsl-BmV6eJ-P.js";import{s as V}from"./ShaderBuilder-JURLrT-H.js";import{c as A}from"./NoParameters-DB-WZ6gy.js";function $e(t,e){switch(t.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
}`),n&&l!==0&&(t.include(Ht,e),a.uniforms.add(s===1?new w("normalTexture",u=>u.textureNormal):new W("normalTexture",u=>u.textureNormal)),d&&(a.uniforms.add(s===1?new Yt("scale",u=>u.scale??wt):new it("scale",u=>u.scale??wt)),a.uniforms.add(new E("normalTextureTransformMatrix",u=>u.normalTextureTransformMatrix??K))),a.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
return linearizeDepth(depthFromTexture(depthTexture, uv), zProjectionMapLastFrame);
  ...
  `),t}const ma=new Fo;ma.useFloatBlend=!1;const Di=Object.freeze(Object.defineProperty({__proto__:null,GlobalIlluminationBlurDrawParameters:vt,build:ha},Symbol.toStringTag,{value:"Module"}));let Je=class extends Q{constructor(){super(...arguments),this.shader=new L(Di,()=>B(()=>Promise.resolve().then(()=>hr),void 0,import.meta.url))}initializePipeline(){return te({colorWrite:ae})}};Je=c([j("esri.views.3d.webgl-engine.effects.globalIllumination.GlobalIlluminationBlurTechnique")],Je);let qe=class extends Q{constructor(){super(...arguments),this.shader=new L(Ti,()=>B(()=>Promise.resolve().then(()=>mr),void 0,import.meta.url))}initializePipeline(){return te({colorWrite:ae})}};qe=c([j("esri.views.3d.webgl-engine.effects.globalIllumination.GlobalIlluminationTechnique")],qe);let Ye=class extends ea{constructor(){super(...arguments),this.hasColor=!0,this.hasEmission=!1,this.rayMarchMaxReach=Oe,this.rayMarchMaxSteps=Re,this.useProjectedRayLength=!0,this.clampRayToScreen=!1}};c([p()],Ye.prototype,"hasColor",void 0),c([p()],Ye.prototype,"hasEmission",void 0);const jt=5e4,zi=100;let gt=class extends A{};function pa(){const t=new V,e=t.fragment;return t.include(fe),t.include(Pe),t.include(ua),e.include(ee),e.include(ct),e.uniforms.add(new w("depthMap",a=>a.depthTexture),new w("normalMap",a=>a.normalTexture),new W("tex",a=>a.colorTexture),new W("globalIlluminationWeightTexture",a=>a.weightTexture),new x("projScale",(a,o)=>{const r=o.camera.distance;return r>jt?Math.max(0,a.projScale-(r-jt)):a.projScale})),e.code.add(i`
...
return readShadowMaps(uvzShadow);
  ...
  `)}function ki(){return new Vi("shadowMap",({shadowMap:t})=>t.getOutput(5)??t.getOutput(7))}function wa(t,e){e.hasColorTextureTransform?(t.varyings.add("colorUV","vec2"),t.vertex.uniforms.add(new E("colorTextureTransformMatrix",a=>a.colorTextureTransformMatrix??K)).code.add(i`void forwardColorUV(){
colorUV = (colorTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):t.vertex.code.add(i`void forwardColorUV(){}`)}function Zi(t,e){e.hasNormalTextureTransform&&e.textureCoordinateType!==0?(t.varyings.add("normalUV","vec2"),t.vertex.uniforms.add(new E("normalTextureTransformMatrix",a=>a.normalTextureTransformMatrix??K)).code.add(i`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):t.vertex.code.add(i`void forwardNormalUV(){}`)}function Ma(t,e){e.hasEmissionTextureTransform&&e.textureCoordinateType!==0?(t.varyings.add("emissiveUV","vec2"),t.vertex.uniforms.add(new E("emissiveTextureTransformMatrix",a=>a.emissiveTextureTransformMatrix??K)).code.add(i`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):t.vertex.code.add(i`void forwardEmissiveUV(){}`)}function Ji(t,e){e.hasOcclusionTextureTransform&&e.textureCoordinateType!==0?(t.varyings.add("occlusionUV","vec2"),t.vertex.uniforms.add(new E("occlusionTextureTransformMatrix",a=>a.occlusionTextureTransformMatrix??K)).code.add(i`void forwardOcclusionUV(){
occlusionUV = (occlusionTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):t.vertex.code.add(i`void forwardOcclusionUV(){}`)}function qi(t,e){e.hasMetallicRoughnessTextureTransform&&e.textureCoordinateType!==0?(t.varyings.add("metallicRoughnessUV","vec2"),t.vertex.uniforms.add(new E("metallicRoughnessTextureTransformMatrix",a=>a.metallicRoughnessTextureTransformMatrix??K)).code.add(i`void forwardMetallicRoughnessUV(){
